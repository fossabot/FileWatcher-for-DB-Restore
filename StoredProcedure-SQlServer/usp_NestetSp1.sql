...
/****** Object:  StoredProcedure [dbo].[usp_NestedSP]    Script Date: 3/7/2019 1:22:30 PM ******/
SET ANSI_NULLS ON
;
...
AS
	...
	BEGIN
	    SET @time = CONVERT(VARCHAR, CURRENT_TIMESTAMP - @TIME_NOW, 14)
	    PRINT  @PROC_NAME + ' - ' + @time + 'Table Updated'
	END

	-- Insert statements for procedure here
	-- SELECT * FROM [FN-LN-From-CRM];
	...
	EXEC usp_NestedSP2 1;
	-- SET @bcpCommand = 'bcp "SELECT * FROM [FN-LN-From-CRM] " queryout '
